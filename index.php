          ...
          <div  class="carousel-item active " style="width: auto; height: auto; background-color: rgba(128,128,128,0.5);">
            <a href="view.php?id=93" style="text-decoration: none;color: inherit; border: 20px; border-radius: 10px; border: 20px; border-radius: 10px;">
              ...
              <div>
                ...
                <p style='float: right; margin-right: 140px; margin-top: 60px;'>€ 30,95</p>
                <form action="Toevoegen.php?product=93" style="margin-top: 110px; float: right; margin-right: -60px; ">
          ...
          <div class="carousel-item " style="width: 100%; height: auto; background-color: rgba(128,128,128,0.5); border: 20px; border-radius: 10px;">
            <a href="view.php?id=2" style="text-decoration: none;border: 20px; border-radius: 10px; color: inherit;" >  
              ...
              <div>
                ...
                <p style='float: right; margin-right: 140px; margin-top: 110px;'>€ 42,99</p>
                  	<form action="Toevoegen.php?product=2" style="margin-top: 160px; float: right; margin-right: -60px; "">
          ...
          <div class="carousel-item " style=" height: auto; background-color: rgba(128,128,128,0.5); border: 20px; border-radius: 10px;">
            <a href="view.php?id=102" style="text-decoration: none; color: inherit;">
              ...
              <div>
                ...
                <p style='float: right; margin-right: 140px; margin-top: 110px;'>€ 60,18</p>
                <form action="Toevoegen.php?product=102" style="margin-top: 160px; float: right; margin-right: -60px; ">
